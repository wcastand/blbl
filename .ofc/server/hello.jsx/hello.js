...
var index = require('./node_modules/node-fetch/lib/index.js');
  ...
  ctx.body = `
    ...
    <html>
      ...
      <body>
        ...
        <script src="/assets/hello.jsx/hello.js" type="module"></script>
      </body>
    </html>
  `;
};
...
const __HANDLER = () => {
  return index$2.default.createElement("div", null, index$2.default.createElement(index$1.default, null, "hello world"));
};

var hello = __ofc(__HANDLER, null);
